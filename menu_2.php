...
$result  = $funciones->querySelect("pMENU_GRUPO_USUARIO_B", $arrayName);
$sAcceso = '';
if ($result) {
    while ($fila = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
        $menu .= ' <a href="' . $fila['url'] . '" class="dropdown-toggle">
        ...
        $submodulo = $funciones->querySelect("pMENU_GRUPO_ACCESO_USUARIO_B", $arrayName);

        if ($submodulo) {
            while ($result_submodulo = sqlsrv_fetch_array($submodulo, SQLSRV_FETCH_ASSOC)) {
                $menu .= '<li class="">
									<a href="' . $result_submodulo['url'] . '" id="'.$result_submodulo['Form'].'">
									<i class="menu-icon fa fa-caret-right"></i>

									' . $result_submodulo['Descripcion'] . '
