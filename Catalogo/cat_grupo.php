...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title" align='center'>GRUPO</h3>
  </div>
...
<div class="col-xs-12 col-sm-8 col--4 " >
 ...
 <label for="form-field-mask-2">Grupo</label>
<div class="input-group col-sm-8">
 
  	<span class="input-group-addon" id="sizing-addon2"><a class="glyphicon glyphicon-user"></a></span>
  <input type="text" class="form-control" placeholder="Grupo" aria-describedby="basic-addon1">
</div>
